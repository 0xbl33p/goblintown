...
If GitHub Release assets are unavailable, the same installer payloads are also
available as split files in `water-bear86/goblintown` on the
`release/v0.7.0-beta.1` branch under `release/parts/`.
